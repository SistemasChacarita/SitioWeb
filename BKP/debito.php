...
<html lang="es">
  ...
  <body class="about-us bg-gray-200">
    ...
    <div class="container">
      <div class="row">
        <h1 class="letraChacaGrande">Ser socio del club</h1>
        <hr />
         <div class="card card-plain">
        <div class="row letraChaca">
          <h3>Formulario para solicitar ser socio</h3>
          ...
          <form method="post" action="mail.php"  enctype="multipart/form-data"  >
            <div class="row ">
              <div class="col-md-6 mt-3">
                  ...
                  <input
                    ...
                    name="nombres"
                    class="form-control"
                    value="<?php echo !empty($postData['nombres'])?$postData['nombres']:''; ?>"
                    autocomplete="off"
              ...
              <div class="col-md-6 mt-3">
                ...
                <div class="input-group input-group-static">   <label>Apellido</label>
                  <input
                    type="text"
                    name="apellido"
                    class="form-control "
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12  mt-3">
                  <div class="input-group input-group-static"> 
                        ...
                        <select class="form-control" name="tipoDocumento"  placeholder="Tipo de documento">
             ...
             <div class="col-lg-3 col-md-6 col-sm-12  mt-3">
                <div class="input-group input-group-static"> <label>Número de documento</label>
                    <input
                      type="number" data-maxlength="12" oninput="this.value=this.value.slice(0,this.dataset.maxlength)" 
                      name="ndocumento"
                      class="form-control "
                      value="<?php echo !empty($postData['ndocumento'])?$postData['ndocumento']:''; ?>"
                     autocomplete="off" 
                      required=""
                    />
              </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12  mt-3">
                  <div class="input-group input-group-static"> <label>Fecha de nacimiento</label>
                      <input
                        type="date"
                        name="fechanacimiento"
                        class="form-control"
                        value="<?php echo !empty($postData['fechanacimiento'])?$postData['fechanacimiento']:''; ?>"
                ...
                <div class="col-lg-3 col-md-6 col-sm-12  mt-3">
                      <div class="input-group input-group-static"> 
                            <label>Género</label>
                            <select class="form-control" name="genero"  placeholder="Género">
     ...
     <div class="row">
            <div class="col-md-6 mt-3">
                  <div class="input-group input-group-static"> 
                      ...
                      <input
                        ...
                        name="telefono"
                        class="form-control"
                        value="<?php echo !empty($postData['telefono'])?$postData['telefono']:''; ?>"
                         autocomplete="off" 
                        required=""
                      />
                  </div>
           ...
           <div class="row">
                <div class="col-md-6 mt-3">
                  <div class="input-group input-group-static">
                      ...
                      <input
                        ...
                        name="direccion"
                        class="form-control"
                        value="<?php echo !empty($postData['direccion'])?$postData['direccion']:''; ?>"
                         autocomplete="off"
                    autocapitalize="words"
                        required=""
                      />
              ...
              <div class="col-md-6 mt-3">
                <div class="input-group input-group-static"> <label>Localidad</label>
                  <input
                    type="localidad"
                    name="localidad"
                    class="form-control"
                     autocomplete="off"
                    autocapitalize="words"
                    value="<?php echo !empty($postData['localidad'])?$postData['localidad']:''; ?>"
             ...
             <div class="row  ">
                <div class="col-md-6 mt-3">
                  <div class="input-group input-group-static"> <label>Provincia</label>
                ...
                <div class="col-md-3 mt-3">
                    <div class="input-group input-group-static"> <label>Código Postal</label>
                      <input
                        type="cp"
                        name="cp"
                        class="form-control"
              ...
              <div class="col-md-6 mt-3">
                  <div class="input-group input-group-static mt-4"> 
                      ...
                      <input
                        ...
                        name="profesion"
                        class="form-control"
                        value="<?php echo !empty($postData['profesion'])?$postData['profesion']:''; ?>"
                           autocomplete="off"
                    autocapitalize="words"
                      />
                  </div> 
                  ...
                  <div class="input-group input-group-static"> 
                      ...
                      <textarea
                        ...
                        placeholder="Escriba alguna observación "
                          autocomplete="off"
                      >
                        <?php echo !empty($postData['observaciones'])?$postData['observaciones']:''; ?>
                        </textarea>
                  </div>
              </div>
          </div>
            ...
            <div class="col-md-3 mt-3">
             ...
             <div class="col-md-3 mt-3">
                <div class="form-group form-file-upload form-file-simple">
                  ...
                  <input type="file" name="fotoDNIfrente"  accept="image/*"  class="inputFileHidden">
                  <br> <br>
                </div>
            </div>
             <div class="col-md-3 mt-3">
                <div class="form-group form-file-upload form-file-simple">
                  ...
                  <input type="file" name="fotoDNIreverso"  accept="image/*"  class="inputFileHidden">
                  <br> <br>
                </div>
            </div>
          </div>
